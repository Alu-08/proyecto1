...
export class Productos {
  ...
  Productos: Producto[] = [
    ...
    {
      id: 7,
      nombre: 'Yerba Mate Sabor COCO',
      descripcion: 'Yerba mate sin palo sabor COCO de 1kg',
      precio: 15000,
      stock: 30,
      disponible: true,
      imagen: 'Paquete COCO1kg.png',
      detalles: 'La yerba mate sin palo sabor coco de 1kg es una opción increible para quienes prefieren un sabor más suave y tropical. Con un precio de 15000 pesos, esta yerba ofrece una excelente relación calidad-precio para quienes buscan disfrutar de un buen mate sin gastar demasiado. Su presentación en paquete de 1kg garantiza una buena cantidad de yerba para compartir con amigos y familiares.',
      cantidad: 1,  
    },
    {
      id: 8,
      nombre: 'Yerba Mate Sabor COCO',
      descripcion: 'Yerba mate sin palo sabor COCO de 500gr',
      precio: 7500,
      stock: 25,
      disponible: true,
      imagen: 'Paquete COCO500gr.png',
      detalles: 'La yerba mate sin palo sabor coco de 1kg es una opción increible para quienes prefieren un sabor más suave y tropical. Con un precio de 15000 pesos, esta yerba ofrece una excelente relación calidad-precio para quienes buscan disfrutar de un buen mate sin gastar demasiado. Su presentación en paquete de 1kg garantiza una buena cantidad de yerba para compartir con amigos y familiares.',
      cantidad: 1,  
    },
    {
      id: 9,
      nombre: 'Yerba Mate Sabor Jengibre&Limon',
      descripcion: 'Yerba mate sin palo sabor Jengibre y Limon de 1kg',
      precio: 15000,
      stock: 45,
      disponible: true,
      imagen: 'Paquete jengibre 1kg.png',
      detalles: 'La yerba mate sin palo sabor coco de 1kg es una opción increible para quienes prefieren un sabor más suave y tropical. Con un precio de 15000 pesos, esta yerba ofrece una excelente relación calidad-precio para quienes buscan disfrutar de un buen mate sin gastar demasiado. Su presentación en paquete de 1kg garantiza una buena cantidad de yerba para compartir con amigos y familiares.',
      cantidad: 1,  
    },
  ];
